...
public class AierController : MonoBehaviour
{
    ...
    private AierAttack playerAttack;
    ...
    private void Awake()
    {
        playerAttack = GetComponent<AierAttack>();
...
//     StartCoroutine(PerformSpecial2WithDelay());
// }

// // Coroutine to spawn the fireball after a delay
// private IEnumerator PerformSpecial2WithDelay()
// {
//     // Wait for 0.5 seconds
//     yield return new WaitForSeconds(0.5f);

//     // Spawn the fireball after the delay
