...
public class CeciliaAttack : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        ceciliacontroller = GetComponent<CeciliaController>();
    }
    ...
    void ComboAttack()
{
    ...
    if (Input.GetKeyDown(KeyCode.J) && canPunch)
    {
        ...
        if (currentComboState == ComboState.Punch2 || ceciliacontroller.isJumping || ceciliacontroller.isCrouching || ceciliacontroller.isAttacking || ceciliacontroller.isStunned)
        {
            return;
        }
