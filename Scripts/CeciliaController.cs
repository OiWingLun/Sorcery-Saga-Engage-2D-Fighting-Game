...
public class CeciliaController : MonoBehaviour
{
    ...
    private CeciliaAttack playerAttack;
    ...
    private void Awake()
    {
        playerAttack = GetComponent<CeciliaAttack>();
    ...
    private void HandleUserInput()
{
    ...
    if (Input.GetKeyDown(KeyCode.L) && !isCrouching && !isJumping)
    {
        Special1();
    }
...
private void CrouchAttack2()
{
    ...
    StartCoroutine(EndAttackAfterDelay(0.6f)); // Reset flags after attack delay
}
