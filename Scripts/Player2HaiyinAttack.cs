...
public enum Player2HaiyinComboState {
    None,
    Punch1,
    Punch2,
    Kick1
...
public class Player2HaiyinAttack : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        player2Haiyin = GetComponent<Player2Haiyin>();
    }
    ...
    void ComboAttack()
{
    ...
    if (Input.GetKeyDown(KeyCode.J) && canPunch)
    {
        ...
        if (currentComboState == ComboState.Punch4 || player2Haiyin.isJumping || player2Haiyin.isCrouching || player2Haiyin.isAttacking || player2Haiyin.isStunned)
        {
            return;
        }
